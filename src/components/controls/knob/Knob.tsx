...
function turnReducer(turnState: ITurnState, update: Partial<ITurnState>): ITurnState {
  if (update.fraction) {
...
function Knob(props: IKnobProps) {
  ...
  function beginTurn(event: React.MouseEvent<HTMLDivElement, MouseEvent>): void {
    updateTurnState({ origin: { x: event.clientX, y: event.clientY }, turning: true })
  }
